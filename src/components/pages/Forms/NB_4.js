        ...
        <table>
          <tbody>
            ...
            <tr>
                  ...
                  {formErrors.jurisdictionNo && (
                    <p className="error-message">
                      ...
                      <span
                        ...
                        onClick={() => handleClearError("jurisdictionNo")}
                      >
                        X
                      </span>
                    </p>
              ...
              <td>
                <div className="form-item">
                  <label htmlFor="national_BoardNo">
                    8. NATIONAL BOARD NO.
                  </label>
                  <input
                    type="text"
                    id="national_BoardNo"
                    name="national_BoardNo"
                    value={form4Data.national_BoardNo}
                  ...
                  {formErrors.national_BoardNo && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("national_BoardNo")}
                      >
                        X
                      </span>
                    </p>
              ...
              <td>
                <div className="form-item">
                  <label htmlFor="name_Manufacturer">
                  ...
                  <input
                    ...
                    value={form4Data.name_Manufacturer}
                    onChange={handleChange}
                  />
                  {formErrors.name_Manufacturer && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("name_Manufacturer")}
                      >
                        X
                      </span>
                    </p>
                ...
                <div className="form-item">
                  ...
                  {formErrors.name_Owner && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("name_Owner")}
                      >
                        X
                      </span>
                    </p>
            ...
            <tr>
              <td colSpan="6">
                <div className="form-item">
                  <label htmlFor="name_Owner_Country">
                    11. NAME OF OWNER INCLUDING COUNTY:
                  </label>
                  <input
                    type="text"
                    id="name_Owner_Country"
                    name="name_Owner_Country"
                    value={form4Data.name_Owner_Country}
                    onChange={handleChange}
                  />
                  {formErrors.name_Owner_Country && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("name_Owner_Country")}
                      >
                        X
                      </span>
                    </p>
            ...
            <tr>
              <td colSpan="6">
                <div className="form-item">
                  <label htmlFor="location_Object_Country">
                    12. LOCATION OF OBJECT INCLUDING COUNTY:
                  </label>
                  <input
                    type="text"
                    id="location_Object_Country"
                    name="location_Object_Country"
                    value={form4Data.location_Object_Country}
                    onChange={handleChange}
                  />
                  {formErrors.location_Object_Country && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() =>
                          handleClearError("location_Object_Country")
                        }
                      >
                        X
                      </span>
                ...
                <div className="form-item">
                  ...
                  {formErrors.user_Object && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("user_Object")}
                      >
                        X
                      </span>
                    </p>
            ...
            <tr>
              <td colSpan="2">
                <div className="form-item">
                  <label htmlFor="date_Last_Certificate">
                    14. DATE OF LAST CERTIFICATE INSPECT., IF ANY:
                  </label>
                  <input
                    type="text"
                    id="date_Last_Certificate"
                    name="date_Last_Certificate"
                    value={form4Data.date_Last_Certificate}
                    onChange={handleChange}
                  />
                  {formErrors.date_Last_Certificate && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() =>
                          handleClearError("date_Last_Certificate")
                        }
                      >
                        X
                      </span>
                ...
                <div className="option-buttons reason-options">
                  <div
                    className={`centered-option${
                      form4Data.certificateIssued === "yes" ? " selected" : ""
                    }`}
                  >
                    <input
                      type="checkbox"
                      ...
                      onChange={() =>
                        handleOptionChange("certificateIssued", "yes")
                      }
                    />
                  ...
                  <div
                    className={`centered-option${
                      form4Data.certificateIssued === "no" ? " selected" : ""
                    }`}
                  >
                    <input
                      type="checkbox"
                      ...
                      onChange={() =>
                        handleOptionChange("certificateIssued", "no")
                      }
                    />
                  ...
                  {formErrors.certificateIssued && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("certificateIssued")}
                      >
                        X
                      </span>
                    </p>
              ...
              <td>
                <div className="form-item">
                  ...
                  <div className="option-buttons reason-options">
                    <div
                      className={`centered-option${
                        form4Data.reasonDiscontinuance === "phys_condition"
                          ? " selected"
                          : ""
                      }`}
                    >
                      <input
                        type="checkbox"
                        id="phys_condition"
                        name="reasonDiscontinuance"
                        value="phys_condition"
                        checked={
                          form4Data.reasonDiscontinuance === "phys_condition"
                        }
                        onChange={() =>
                    ...
                    <div
                      className={`centered-option${
                        form4Data.reasonDiscontinuance === "out_use"
                          ? " selected"
                          : ""
                      }`}
                    >
                      <input
                        ...
                        onChange={() =>
                          handleOptionChange("reasonDiscontinuance", "out_use")
                        }
                      />
                    ...
                    <div
                      className={`centered-option${
                        form4Data.reasonDiscontinuance === "other"
                          ? " selected"
                          : ""
                      }`}
                    >
                      <input
                        ...
                        onChange={() =>
                          handleOptionChange("reasonDiscontinuance", "other")
                        }
                      />
                    ...
                    {formErrors.reasonDiscontinuance && (
                      <p className="error-message">
                        ...
                        <span
                          className="close-button"
                          onClick={() =>
                            handleClearError("reasonDiscontinuance")
                          }
                        >
                          X
                        </span>
              ...
              <td colSpan={2}>
                <div className="form-item">
                  <input
                    ...
                    value={form4Data.chief_inspector}
                    onChange={handleChange}
                  />
                  {formErrors.chief_inspector && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("chief_inspector")}
                      >
                        X
                      </span>
                    </p>
                  ...
                  {formErrors.branch_office && (
                    <p className="error-message">
                      ...
                      <span
                        className="close-button"
                        onClick={() => handleClearError("branch_office")}
                      >
                        X
                      </span>
                    </p>
